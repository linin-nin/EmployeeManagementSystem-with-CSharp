...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Admin\Documents\employee-db.mdf;Integrated Security=True;Connect Timeout=30;Encrypt=false");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"D:\Employee-Management-System\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT * FROM employees WHERE full_name LIKE @searchText AND delete_date IS NULL";
                using (SqlCommand cmd = new SqlCommand(query, connect))
                {
                    cmd.Parameters.AddWithValue("@searchText", "%" + searchInput.Text.Trim() + "%");
        ...
        private void addEmployee_gender_SelectedIndexChanged(object sender, EventArgs e)
        {
